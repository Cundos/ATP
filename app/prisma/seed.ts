...
export const INITIAL_PLANTS_DATA: SeedPlantData[] = [
  ...
  },
  {
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'En maceta, con floración y brotes nuevos. [source: manual patio inventory 2026-09-19]',
  },
  {
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Ejemplar joven. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-016',
    common_name: 'Suculenta colgante',
    scientific_name: null,
    cultivar: null,
    health_status: 'ATTENTION',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Maceta colgante; taxonomía a precisar. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-017',
    common_name: 'Monstera joven',
    scientific_name: 'Monstera deliciosa',
    cultivar: null,
    health_status: 'ATTENTION',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Comparte maceta con otro ejemplar (AT-PL-018). [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-018',
    common_name: 'Planta de hojas acintadas',
    scientific_name: null,
    cultivar: null,
    health_status: 'HEALTHY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Comparte maceta con AT-PL-017. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-019',
    common_name: 'Potus',
    scientific_name: 'Epipremnum aureum',
    cultivar: null,
    health_status: 'RECOVERY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Ejemplar estresado / en recuperación. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-020',
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Estado healthy confirmado. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-021',
    common_name: 'Sansevieria enana / Hahnii',
    scientific_name: 'Dracaena trifasciata',
    cultivar: null,
    health_status: 'ATTENTION',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Roseta compacta. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-022',
    common_name: 'Tradescantia morada',
    scientific_name: 'Tradescantia spathacea',
    cultivar: null,
    health_status: 'HEALTHY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: '[source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-023',
    common_name: 'Portulacaria / Arbusto elefante',
  ...
  },
  {
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'En flor. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-025',
    common_name: 'Suculenta de roseta',
    scientific_name: null,
    cultivar: null,
    health_status: 'HEALTHY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Identificación tentativa: Graptopetalum / Graptoveria sp. No persistir especie definitiva todavía. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-026',
    common_name: 'Suculenta de rosetas sobre tallos',
    scientific_name: null,
    cultivar: null,
    health_status: 'HEALTHY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Identificación tentativa: Aeonium / Sedum sp. No persistir especie definitiva todavía. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-027',
    common_name: 'Lantana',
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Al pie del nogal. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-028',
    common_name: 'Nogal',
    ...
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Árbol principal del patio. [source: manual patio inventory 2026-09-19]',
  },
  {
    permanent_code: 'AT-PL-029',
    common_name: 'Arbolito joven',
    scientific_name: null,
    cultivar: null,
    health_status: 'HEALTHY',
    lifecycle_status: 'ACTIVE',
    acquisition_date: null,
    notes: 'Hojas palmatilobadas; falta identificación definitiva. [source: manual patio inventory 2026-09-19]',
  },
];
...
export async function seed(prisma: PrismaClient) {
  ...
  console.log(`${INITIAL_PLANTS_DATA.length} plantas cargadas/actualizadas con ubicaciones canónicas mediante upsert idempotente.`);
