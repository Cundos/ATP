...
| **Milestone 2: Fotos** (`v0.0.3-photos`) | Almacenamiento & Multimedia | `LocalFileStorageService`, preprocesamiento con `sharp` a WebP, streaming seguro `/api/photos/view/`, reemplazo de foto principal preservando histórico en disco. | `GATE-2` | **EN PROGRESO (ATP-IMP-016 y ATP-IMP-017 completados, GATE-2 PENDIENTE)** |
