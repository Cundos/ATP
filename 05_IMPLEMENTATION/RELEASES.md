...
| **Milestone 3: Open Plantbook** (`v0.0.4-plantbook`) | Conocimiento Botánico Asistido | OAuth2 server-side, `OpenPlantbookClient` resiliente (429/timeout), snapshot persistente `PlantReference`, modal de búsqueda asistida no bloqueante. | `GATE-3` | **EN PROGRESO (GATE-3 PENDIENTE)** |
